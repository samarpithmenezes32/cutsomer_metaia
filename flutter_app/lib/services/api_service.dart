...
class ApiService {
  ...
  Future<Map<String, dynamic>> updateProfile(Map<String, dynamic> data) async {
    final res = await http.put(
      _uri(ApiConstants.updateProfile),
      headers: _headers,
      body: jsonEncode(data),
    );
    return _send(res);
  ...
  Future<Map<String, dynamic>> createPayment(
    ...
    final res = await http.post(
      _uri(ApiConstants.createPayment),
      headers: _headers,
  ...
  Future<Map<String, dynamic>> verifyPayment(
    ...
    final res = await http.post(
      _uri(ApiConstants.verifyPayment),
      headers: _headers,
  ...
  Future<Map<String, dynamic>> saveMeasurement(
    ...
    final res = await http.post(
      _uri(ApiConstants.saveMeasurement),
      headers: _headers,
  ...
  Future<Map<String, dynamic>> getMeasurements() async {
    final res = await http.get(
      _uri(ApiConstants.measurements),
      headers: _headers,
    );
    return _send(res);
  }
  ...
  Future<Map<String, dynamic>> createReview(
    ...
    final res = await http.post(
      _uri(ApiConstants.createReview),
      headers: _headers,
